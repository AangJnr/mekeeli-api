...
@router.post("/mcp_servers/", response_model=schemas.McpServer, dependencies=[Depends(security.get_current_active_user)])
...
@router.get("/mcp_servers/", response_model=list[schemas.McpServer], dependencies=[Depends(security.get_current_active_user)])
...
@router.get("/mcp_servers/{server_id}", response_model=schemas.McpServer, dependencies=[Depends(security.get_current_active_user)])
