...
@router.post("/permissions/", response_model=schemas.Permission, dependencies=[Depends(security.get_current_active_user)])
...
@router.get("/permissions/", response_model=list[schemas.Permission], dependencies=[Depends(security.get_current_active_user)])
...
@router.get("/permissions/{permission_id}", response_model=schemas.Permission, dependencies=[Depends(security.get_current_active_user)])
